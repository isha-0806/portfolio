...
const Navbar = () => {
  ...
  return (
    <nav className="sticky border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
        ...
        <div className="mobile-menu block md:hidden">
          {!navbarOpen ? (
            <button
              ...
              className="text-slate-200 flex items-center px-3 py-2 rounded border border-slate-200 hover:text-white hover:border-white"
            >
